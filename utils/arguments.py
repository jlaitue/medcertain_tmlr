...
def args_parser():
    ...
    parser.add_argument('--dataset', type=str, default='mimic-cxr')  # mimic-cxr, mimic-fusion
    parser.add_argument("--num_workers", type=int, default=16) # CAREFUL WITH THIS BECAUSE OF DATALOADER
    parser.add_argument('--prediction_type', type=str, default='classification')
    parser.add_argument('--mimic_task', type=str, default='in-hospital-mortality')
    ...
    parser.add_argument("--upscale_mimic_loss", action="store_true", default=False)
    ...
    parser.add_argument('--wandb_project', type=str, default='medcertain')
    parser.add_argument('--wandb_account', type=str, default='lab')
