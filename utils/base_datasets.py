...
from utils.functions import numpy_collate
...
def read_timeseries(args):
        path = f"{args['ehr_data_dir']}/in-hospital-mortality/train/14991576_episode3_timeseries.csv"
        ret = []
...
def get_normalizer(discretizer, args):
    ...
    if normalizer_state is None:
        ...
        normalizer_state = os.path.join(os.getcwd(), normalizer_state)
